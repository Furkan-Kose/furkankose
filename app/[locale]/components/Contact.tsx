...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative text-gray-900 dark:text-gray-300 pt-32 pb-16 bg-gradient-to-b from-gray-100 via-gray-100 to-gray-200 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-20 2xl:px-24"
    >
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <motion.div
            className="flex flex-col justify-center items-center md:items-start p-8 bg-gradient-to-br from-gray-200 via-blue-200 to-gray-200 dark:from-gray-800 dark:via-blue-950 dark:to-gray-800 rounded-lg shadow-lg hover:bg-gray-800 transition-transform transform hover:scale-105"
          ...
          <motion.div
            className="p-8 bg-gradient-to-br from-gray-200 via-blue-200 to-gray-200 dark:from-gray-800 dark:via-blue-950 dark:to-gray-800 rounded-lg shadow-lg transition-transform transform hover:scale-105"
            initial={{ opacity: 0, x: 50 }}
            animate={inView ? { opacity: 1, x: 0 } : { opacity: 0, x: 50 }}
